...
INSERT INTO [dbo].[Herramientas] ([Id], [Nombre], [Material], [Precio], [TiempoReparacion], [FabricanteId]) VALUES (3, N'Tornillo', N'Acero', CAST(1.15 AS Decimal(10, 2)), 1, 1)
INSERT INTO [dbo].[Herramientas] ([Id], [Nombre], [Material], [Precio], [TiempoReparacion], [FabricanteId]) VALUES (4, N'Tuerca', N'Acero', CAST(1.40 AS Decimal(10, 2)), 1, 3)
INSERT INTO [dbo].[Herramientas] ([Id], [Nombre], [Material], [Precio], [TiempoReparacion], [FabricanteId]) VALUES (5, N'Martillo', N'Plastico', CAST(10.00 AS Decimal(10, 2)), 3, 3)
...
INSERT INTO [dbo].[Reparaciones] ([Id], [FechaEntrega], [FechaRecogida], [PrecioTotal], [TiposMetodoPago], [ApplicationUserId]) VALUES (1, N'2025-10-21 00:00:00', N'2025-10-22 00:00:00', 25.00, 1, 5)
SET IDENTITY_INSERT [dbo].[Reparaciones] OFF

INSERT INTO [dbo].[ReparacionItems] ([ReparacionId], [HerramientaId], [Precio], [Cantidad], [Descripcion]) VALUES (1, 1, 25.00, 2, N'Cambiarle la punta')

SET IDENTITY_INSERT [dbo].[Alquileres] ON
INSERT INTO [dbo].[Alquileres] ([Id], [DireccionEnvio], [FechaAlquiler], [FechaFin], [FechaInicio], [Periodo], [PrecioTotal], [TiposMetodoPago], [ApplicationUserId]) VALUES (1, N'Calle Mayor 12, Madrid', N'2025-10-14 00:00:00', N'2025-10-20 00:00:00', N'2025-10-15 00:00:00', 5, CAST(312.50 AS Decimal(10, 2)), 0, N'1')
INSERT INTO [dbo].[Alquileres] ([Id], [DireccionEnvio], [FechaAlquiler], [FechaFin], [FechaInicio], [Periodo], [PrecioTotal], [TiposMetodoPago], [ApplicationUserId]) VALUES (2, N'Avenida Andalucía 45, Sevilla', N'2025-11-10 00:00:00', N'2025-11-17 00:00:00', N'2025-11-11 00:00:00', 6, CAST(185.40 AS Decimal(10, 2)), 1, N'2')
...
INSERT INTO [dbo].[AlquilarItems] ([AlquilerId], [HerramientaId], [Cantidad], [Precio]) VALUES (1, 1, 3, CAST(312.50 AS Decimal(10, 2)))
INSERT INTO [dbo].[AlquilarItems] ([AlquilerId], [HerramientaId], [Cantidad], [Precio]) VALUES (2, 2, 3, CAST(185.40 AS Decimal(10, 2)))
INSERT INTO [dbo].[AlquilarItems] ([AlquilerId], [HerramientaId], [Cantidad], [Precio]) VALUES (3, 1, 3, CAST(150.00 AS Decimal(10, 2)))
...
INSERT INTO [dbo].[Compras] ([Id], [DireccionEnvio], [FechaCompra], [PrecioTotal], [TipoMetodoPago], [ApplicationUserId]) VALUES (2, N'Calle Juan', N'2025-08-10 00:00:00', CAST(101.00 AS Decimal(10, 2)), 1, NULL)
...
INSERT INTO [dbo].[CompraItems] ([HerramientaId], [CompraId], [Cantidad], [Descripcion], [Precio]) VALUES (3, 2, 100, N'Tuercas', CAST(100.00 AS Decimal(10, 2)))
INSERT INTO [dbo].[CompraItems] ([HerramientaId], [CompraId], [Cantidad], [Descripcion], [Precio]) VALUES (4, 2, 1, N'Tornillo', CAST(1.00 AS Decimal(10, 2)))
